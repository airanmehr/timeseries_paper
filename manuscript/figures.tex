...
\begin{figure}[H]
	...
	0.0in,clip,width=0.6\textwidth]{man-dmel-snp.pdf}&	
	\includegraphics[trim=0.1in 0.in 0in 
	0.0in,clip,width=0.35\textwidth]{{topVariants.dmel}.pdf}
	\end{tabular}
	\caption{{\bf Single locus analysis of the \datadm.}\\ Manhattan plot 
	of scan for testing directional selection (A) and overdominant selection 
	(C).
		Significant variants with FDR$\le 0.001$ and FDR $\le 0.01$ are denoted 
...
\begin{figure}[H]
	\centering
	\includegraphics[width=0.8\textwidth]{man-dmel-region.pdf}
