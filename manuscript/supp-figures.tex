...
\begin{figure}[H]
	\centering
	\includegraphics[width=0.6\textwidth]{{bias.null}.pdf}
	\caption{Distribution of bias for null simulations with coverage $\lambda\in 
		\{30,100,300\}$. }
	\label{fig:biasNull}
\end{figure}
\ignore{
...
\begin{figure}[H]
	...
	\begin{tabular}{c|c}	
		(A)&(B)\\
		\includegraphics[width=0.45\textwidth]{decayFactors0}
		& 		\includegraphics[trim=0.35in 0.in 1.4in 
		.5in,clip, width=0.5\textwidth]{{winSize}.pdf}
	\end{tabular}
