...
\begin{figure}[H]
	...
	clip,width=\textwidth]{powerROC.pdf}
...
\begin{figure}[H]
	\centering
	\includegraphics[width=0.6\textwidth]{{bias.inf}.pdf}
...
\begin{figure}[H]
	...
	\begin{tabular}{l|l}
		(A)&(B)\\
		\includegraphics[width=0.5\textwidth]{decayFactors0}
		&\includegraphics[width=0.5\textwidth]{decayFactors1}\\
		\hline(C)&(D)\\
		\includegraphics[width=0.5\textwidth]{decayFactors2}
		&\includegraphics[width=0.5\textwidth]{decayFactors3}		
	\end{tabular}
...
\begin{figure}[H]
	\centering
	\includegraphics[trim=.2in 0 .2in 0, 
	clip,width=\textwidth]{rankinf.pdf}
