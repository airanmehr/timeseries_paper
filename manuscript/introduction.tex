...
chose to adopt existing tests that originally used for static data,
for scanning dynamic data with two time-points. For instance, Zhu
...
observation of data on case and control populations. \VB{Something
  wrong with the name?} Orozco-terWengel \emph{et
