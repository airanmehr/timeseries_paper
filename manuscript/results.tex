...
$\le0.05$ within selected regions using single locus hypothesis testing.
...
The selected 216 variants fall within 33 
genes~\ref{tab:genes}. 
We also performed GO
enrichment using \texttt{Gowinda}~\cite{kofler2012gowinda} and found 4
