...
\beq
\frac{t_1}{2} s&=  \left( \eta(x_{t_1})-\eta(x_0)\right)\\
&\vdots\\
\frac{t_T}{2}s&= \left( \eta(x_{t_T})-\eta(x_0)\right)\\
\eeq
...
\beq
s_d\sim \Nc\left(0,\frac{4h_0}{t}\right)
\eeq
...
\beq
s^* = \frac{\sum_r  \frac{t}{2} (\eta(x_{r,t})-\eta(x_0)) }{\sum_r   
(\frac{t}{2})^2}=\frac{\sum_r   (\eta(x_{r,t})-\eta(x_0)) }{\frac{Rt}{2}}=
\frac{1}{R}\sum_r \frac{2}{t}  (\eta(x_{r,t})-\eta(x_0)) =  \frac{1}{R} \sum_r 
s^*_r
\eeq
or simply is the average of estimates of independent replicares, which means 
for $R$ replicates we have
\beq
s_d\sim \Nc\left(0,\frac{4h_0}{Rt}\right)
\eeq
...
\beq
s \sim \Nc(0,\frac{8t}{N } (\frac{2}{t})^2)= \Nc(0,\frac{32}{tN } )
\eeq 
also for R replicates we have
\beq
s \sim = \Nc(0,\frac{32}{tNR } )
\eeq 
