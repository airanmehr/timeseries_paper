...
In the selective sweep with infinite population size, dynamic of allele 
frequencies 
...
logistic model for allele frequencies to estimate the strength of selection for 
each 
site.
\begin{figure}[t]
	\begin{tabular}{lr}
...
y_{t}^{j} (1-y_{t})^{2N-j} 
\eeq
where $y_t(x_t)$ is comped via \ref{eq:transition}.
>>>>>>> 6f089d759b7b2751933cc9c4268d234cc2748eba
