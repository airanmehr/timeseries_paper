...
$\tau>1$. To test this we simulated 150K simulations for $\nu_0=0.005$ and 
...
\paragraph{Logistic Model for Selection.}
...
We also considered SFS based tests for detecting selection. We looked  a nim 
