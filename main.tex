...
\begin{figure}[H]
	\includegraphics[trim=0in 0.1in 1in 0.1in,clip,width=\textwidth]{AF.pdf}
...
\begin{figure}[H]
	\centering
	\includegraphics[width=\textwidth]{{manhattanSNP.png}}\\	
	\includegraphics[width=\textwidth]{{manhattanSNP.Genes}.pdf}
...
\begin{figure}[H]
	\centering
		\includegraphics[width=\textwidth]{{manhattanWindow.pdf}}\\	
			\includegraphics[width=\textwidth]{{manhattanWindow.Genes}.pdf}
...
\begin{figure}[H]
	\centering
	\includegraphics[trim=.2in 0 .0in 0, 
	clip,width=\textwidth]{{nullpred}.pdf}
...
\begin{figure}[H]
	...
	\begin{tabular}{cc}
			\includegraphics[trim=.2in 0 .0in 0, 
			clip,width=0.5\textwidth]{{nulls}.pdf}
			&\includegraphics[trim=.2in 0 .0in 0, 
			clip,width=0.5\textwidth]{{nulls.log}.pdf}
	\end{tabular}
