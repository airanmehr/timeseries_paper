...
\begin{itemize}
\item When restricting observations to a fixed set of sites, at each generation some sites get lost (due to drift), but no new mutation happens.
...
\end{figure}
\item We considered sum of top $\hat{s}$ as a predictor of selection for a window. 
\end{enumerate}
...
\begin{figure}
  \centering \includegraphics[page=1,width=\textwidth]{{power}.pdf}
\end{figure}
\begin{figure}
  \centering \includegraphics[page=2,width=\textwidth]{{power}.pdf}
\end{figure}
\begin{figure}
  \centering \includegraphics[page=3,width=\textwidth]{{power}.pdf}
\end{figure}
\begin{figure}
  \centering \includegraphics[page=4,width=\textwidth]{{power}.pdf}
\end{figure}

\begin{figure}
  \centering \includegraphics[page=5,width=\textwidth]{{power}.pdf}
\end{figure}
\begin{figure}
  \centering \includegraphics[page=6,width=\textwidth]{{power}.pdf}
\end{figure}
