...
process~\cite{topa2015gaussian,Terhorst2015Multi}. Significant deviations from 
this
...
also susceptible to this issue (see results and Fig.~\ref{fig:power}A-C).
...
multiple-loci Gaussian process~\cite{Terhorst2015Multi} incorporate these
