...
\paragraph{Sinle Locus Gaussian Process.}
...
\VB{Arya, can you use
  equations~\ref{eq:pooledfrequency}.~\ref{eq:labeledpooled_s} to get
  new estimates of $s$, and see if they are better. Also, in the
  figure, please write a caption as you can, and see if you can
  write
