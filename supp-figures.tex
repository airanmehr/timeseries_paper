...
\begin{figure}[H]
	...
	\caption{{\bf Ranking performance for 30$\times$ coverage.}
          ...
          configuration. In all case \comale\ provides the best performance. 
          Localization in soft sweep is an easier task.}
	\label{fig:rank30}
\end{figure}
\ignore{
\begin{figure}[H]
...
\begin{figure}[H]
	...
	distribution of 
	bias of selection fitness (A-B), $s-\hat{s}$, and overdominance (C-D), 
	$h-\hat{h}$, computed for 500 simulations for a range of choices for the 
	selection
