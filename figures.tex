...
\begin{figure}[H]
	...
	\caption{{\bf Average power of \comale\ statistics as function
          ...
          $s\in\{0.025,0.05,0.075,0.1\}$ for $\Hc_{\pi}$ and
          $\Hc^{+}_{\pi}$. We denote
...
\caption{{\bf Distribution of bias for 100$\times$ coverage.} The
  ...
  lower variance in hard sweep. Also see Table~\ref{XXX}. Panels C,D
